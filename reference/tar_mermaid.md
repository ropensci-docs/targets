...
A character vector of lines of code of the `mermaid.js` graph. You can
visualize the graph by copying the text into a public online
`mermaid.js` editor or a `mermaid` GitHub code chunk
...
`mermaid.js` is a JavaScript library for constructing static
